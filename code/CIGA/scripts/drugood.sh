...
python main.py --device 1 --eval_metric 'auc' --r 0.8 --num_layers 4  --batch_size 128 --emb_dim 128 --model 'gin' --pooling 'sum' -c_dim 128 --dataset 'drugood_lbap_core_ic50_assay' --seed '[1,2,3,4,5]' --dropout 0.5  -c_in 'raw'  -c_rep 'feat'  
python main.py --device 2 --eval_metric 'auc' --r 0.8 --num_layers 4  --batch_size 128 --emb_dim 128 --model 'gin' --pooling 'sum' -c_dim 128 --dataset 'drugood_lbap_core_ic50_scaffold' --seed '[1,2,3,4,5]' --dropout 0.5  -c_in 'feat'  -c_rep 'feat' -s_rep 'conv'  
python main.py --device 3 --eval_metric 'auc' --r 0.8 --num_layers 4  --batch_size 128 --emb_dim 128 --model 'gin' --pooling 'sum' -c_dim 128 --dataset 'drugood_lbap_core_ic50_size' --seed '[1,2,3,4,5]' --dropout 0.1  -c_in 'feat'  -c_rep 'feat' 
